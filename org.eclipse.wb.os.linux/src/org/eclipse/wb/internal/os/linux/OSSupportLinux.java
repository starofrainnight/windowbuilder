...
public abstract class OSSupportLinux<H extends Number> extends OSSupport {
  private static Boolean fIsGTK3 = isGtk3();
  static {
    String libName = fIsGTK3 ? "wbp3" : "wbp";
  ...
  private static boolean isGtk3() {
    ...
    try {
      ...
      try {
        Activator.logError("Error trying to find GTK version, Trying GTK4", e);
        Class<?> GTKClass = Class.forName("org.eclipse.swt.internal.gtk.GTK");
        fIsGTK3 = ReflectionUtils.getFieldBoolean(GTKClass, "GTK4");
      } catch (Throwable e2) {
