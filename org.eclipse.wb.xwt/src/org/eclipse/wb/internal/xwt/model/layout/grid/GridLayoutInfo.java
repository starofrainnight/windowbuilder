...
public class GridLayoutInfo extends LayoutInfo
   ...
   * {@link GridData2}.
   */
  protected void replaceGridLayout() throws Exception {
  ...
  private void addFiller(int column, int row) throws Exception {
    ...
    // prepare filler
    ControlInfo filler =
        (ControlInfo) XmlObjectUtils.createObject(getContext(), Label.class, creationSupport); //the
    System.out.println("I fill with a Label");
    // add filler
