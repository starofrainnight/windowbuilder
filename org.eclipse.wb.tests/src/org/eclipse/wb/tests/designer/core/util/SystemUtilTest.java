...
public class SystemUtilTest extends TestCase {
  ...
  public void testCanParseModernJavaVersion() throws Exception {
    assertEquals(1.8111f, checkCanParseJaveVersion("1.8.111"), 0.000001);
    //
    assertEquals(9.0f, checkCanParseJaveVersion("9"), 0.000001);
    assertEquals(9.0f, checkCanParseJaveVersion("9.0"), 0.000001);
    assertEquals(9.01f, checkCanParseJaveVersion("9.0.1"), 0.000001);
    //
    assertEquals(10.0f, checkCanParseJaveVersion("10"), 0.000001);
    assertEquals(10.0f, checkCanParseJaveVersion("10.0"), 0.000001);
    assertEquals(10.01f, checkCanParseJaveVersion("10.0.1"), 0.000001);
    //
    assertEquals(".1+10 should be ignored", 10.0f, checkCanParseJaveVersion("10.0.1+10"), 0.000001);
  }

  private float checkCanParseJaveVersion(String javaVersion) throws Exception {
